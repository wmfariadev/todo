...
export default class Todo extends Component {
    ...
    constructor(props) {
        ...
        this.handleMarkeAsDone = this.handleMarkeAsDone.bind(this)
        this.handleMarkeAsPending = this.handleMarkeAsPending.bind(this)
        ...
        return (
            <div>
                ...
                <TodoList
                    ...
                    handleMarkeAsDone={this.handleMarkeAsDone}
                    handleMarkeAsPending={this.handleMarkeAsPending} />
            </div>
        )
    }
}